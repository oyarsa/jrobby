...
public class Definicoes {
    ...
    public final static int NUMERO_MOVIMENTOS = 7;
    public final static int MOVE_NORTE = 0;
    ...
    public final static int LATA = 1;
    public final static int PAREDE = 2;

    public final static int NUMERO_SITUACOES = 243;
    public final static int TAMANHO_CROMOSSOMO = NUMERO_SITUACOES;
